...
public class LoginActivity extends ActionBarActivity {
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            Callback callback = new Callback<LoginResult>() {
                @Override
                public void success(LoginResult data, Response response) {
                    showProgress(false);
            ...
            scratchService.login(new LoginRequest(email, password), callback);
        }
    }
    ...
    public void gotoCollection() {
        final Intent collectionsIntent = new Intent(this, CollectionsActivity.class);
